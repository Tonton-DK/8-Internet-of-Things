...
#define DEFAULT_VREF    1100.0   // Default ADC reference voltage in mV
#define LMT86_GAIN     -10.9   // Average sensor gain of the LMT86 temperature sensor
#define LMT86_OFFSET   2100.0   // Offset voltage of the LMT86 temperature sensor
...
uint32_t convert(uint32_t value)
{
    ...
    float voltage = (float)value * DEFAULT_VREF / 4095.0;
    printf("Voltage: %.2f \n", voltage);
